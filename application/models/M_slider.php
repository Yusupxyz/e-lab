...
class M_slider extends CI_Model{
	...
	function get_all_slider(){
		$hsl=$this->db->query("SELECT * FROM tbl_slider ORDER BY slider_id DESC");
		return $hsl;
	}
	function simpan_slider($judul,$tombol,$link,$gambar){
		$hsl=$this->db->query("insert into tbl_slider(slider_promo,slider_foto,slider_tombol,slider_link) values 
		('$judul','$gambar','$tombol','$link')");
		return $hsl;
	}
	function get_slider_by_kode($kode){
		$hsl=$this->db->query("SELECT * FROM tbl_slider where slider_id='$kode'");
		return $hsl;
	}
	function update_slider($id,$judul,$tombol,$link,$gambar){
		$hsl=$this->db->query("update tbl_slider set slider_promo='$judul',slider_foto='$gambar',slider_tombol='$tombol',
				slider_link='$link' where slider_id='$id'");
		return $hsl;
	}
	function update_slider_tanpa_img($id,$judul,$tombol,$link){
		$hsl=$this->db->query("update tbl_slider set slider_promo='$judul',slider_tombol='$tombol',
		slider_link='$link' where slider_id='$id'");
		return $hsl;
	}
