  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default ">
		...
		<form action="<?php echo base_url().'admin/layanan/simpan_layanan'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <input type="text" name="xnama" class="form-control" placeholder="Masukkan Nama Layanan" required/><br>
            </div>
          </div>  
          <div class="row">
            <div class="col-md-12">
            <label for="male">Ikon Layanan*</label>
              <input type="file" name="xikon" class="form-control" accept="image/png" required/><br>
            </div>
          </div>  
          <div class="row">
            <div class="col-md-12">
            <label for="male">Penjelasan Layanan*</label>
              <textarea id="ckeditor" name="xpenjelasan" required></textarea><br>
            </div>
          </div> 
          <div class="row">
            <div class="col-md-12">
