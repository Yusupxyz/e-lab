  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ubah Parameter Uji</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default ">
        <div class="box-header with-border ">
          <h3 class="box-title">Ubah Parameter Uji</h3>
        </div>
		
		<form action="<?php echo base_url().'admin/parameter_uji/update_parameter_uji'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <input type="text" name="xparam" class="form-control" placeholder="Masukkan Parameter Uji" value="<?= $data->pu_nama ?>" required/><br>
            </div>
          </div> 
          <div class="row">
            <div class="col-md-12">
              ...
              <?php
                        echo form_dropdown('xsifat', $sp, $data->pu_sp_id, $attribute);
                    ?><br>
            </div>
          </div>
          <div class="row">
