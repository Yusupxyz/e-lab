...
<?php foreach ($data->result_array() as $i) :
	...
	<!--Modal Hapus Pengguna-->
        <div class="modal fade" id="ModalHapus<?php echo $status_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/status/hapus'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $status_id;?>"/> 
                            <p>Apakah Anda yakin mau menghapus Status <b><?php echo $status_nama;?></b> ?</p>
