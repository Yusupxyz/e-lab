  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default ">
		...
		<form action="<?php echo base_url().'admin/status/simpan'?>" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              <input type="text" name="xnama" class="form-control" placeholder="Masukkan Status" required/><br>
            </div>
          </div> 
          <div class="row">
            <div class="col-md-12">
              ...
              <?php
                        echo form_dropdown('xclass', $class, $xclass, $attribute);
                    ?><br>
          </div>  
          </div>
          <div class="row">
