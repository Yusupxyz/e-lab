  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default ">
		...
		<form action="<?php echo base_url().'admin/status/update'?>" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="hidden" name="xid" class="form-control" value="<?= $data->status_id ?>" /><br>
              <!-- /.form-group -->
            </div>
            </div>
            <!-- /.col -->
