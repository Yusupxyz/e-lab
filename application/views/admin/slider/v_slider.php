        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/slider/add_slider'?>"><span class="fa fa-plus"></span> Tambah Baru</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   ...
          					   $slider_promo=$i['slider_promo'];
          					   $slider_foto=$i['slider_foto'];
          					   $slider_tombol=$i['slider_tombol'];
          					   $slider_link=$i['slider_link'];
                       
                    ?>
                <tr>
                  <td><?php echo $no++;?></td>
                  <td><?php echo $slider_promo;?></td>
                  <td><img src="<?php echo base_url().'assets/slider/'.$slider_foto;?>" style="width:90px;"></td>
                  <?php if ($slider_tombol!=null) { ?>
        				    <td><a href="<?php echo $slider_link;?>"><?php echo $slider_tombol;?></a></td>
                  <?php }else{ ?>
                    <td>-</td>
                  <?php } ?>
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'admin/slider/get_edit/'.$slider_id;?>"><span class="fa fa-pencil"></span></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">       
                     ...
                     <input type="hidden" value="<?php echo $slider_foto;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus Slider <b><?php echo $slider_promo;?></b> ?</p>
