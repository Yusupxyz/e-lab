...
<div class="register-box">
  ...
  <p align="center"><b>E-LAB </b></p>
    ...
    <form action="<?php echo base_url().'administrator/registrasi'?>" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" name="personil" class="form-control" placeholder="Nama Personil Penghubung" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button name="submit" type="submit" class="btn btn-primary btn-block btn-flat" id="submit">Daftar</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
