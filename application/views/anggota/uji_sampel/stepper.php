            ...
            <form  action="<?php echo base_url().'anggota/uji_sampel/simpan'?>" method="post" class="multisteps-form__form">
              ...
              <div class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="scaleIn">
                ...
                <div class="multisteps-form__content">
                  ...
                  <div class="button-row d-flex mt-4">
                    <button id="button1" class="btn btn-primary ml-auto js-btn-next" type="button" title="Next" disabled>Next</button>
                  </div>
                </div>
              </div>
              <!--single form panel-->
              <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                ...
                <div class="multisteps-form__content">
                  <div class="form-row mt-4">
                    <div class="col">
                      <input class="multisteps-form__input form-control" type="text" name="xkode" id="xkode" placeholder="Kode/Nama Sampel Pelanggan"/>
                    </div>
                  </div>
                  <div class="form-row mt-4">
                    <div class="col">
                  ...
                  <div class="button-row d-flex mt-4">
                    ...
                    <button id="button2" class="btn btn-primary ml-auto js-btn-next" type="button" title="Next" disabled>Next</button>
                  </div>
                </div>
              </div>
              <!--single form panel-->
                ...
                <div class="multisteps-form__content">
                  ...
                  <div class="row">
                    <div class="button-row d-flex mt-4 col-12">
                      <button class="btn btn-primary js-btn-prev" type="button" title="Prev">Prev</button>
                      <button id="button3" class="btn btn-primary ml-auto js-btn-next" type="button" title="Next" disabled>Next</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p>Apa anda yakin mengirim data uji sampel anda?</p>
                    </div>
