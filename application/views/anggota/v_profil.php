      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            ...
            <form action="<?php echo base_url().'anggota/profil/update_anggota'?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama</label>
                  <input type="text" name="nama" class="form-control" placeholder="Masukkan nama" value="<?= $data->anggota_nama ?>" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Username</label>
                  <input type="text" name="username" class="form-control" placeholder="Masukkan username" value="<?= $data->anggota_username ?>" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Alamat</label>
                  <textarea name="alamat" class="form-control" placeholder="Masukkan alamat" required><?= $data->anggota_alamat ?></textarea>
                  <span class="glyphicon glyphicon-flag form-control-feedback"></span>
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Personil Penghubung</label>
                  <input type="text" name="personil" class="form-control" placeholder="Masukkan nama personil penghubung" value="<?= $data->anggota_personil ?>" required>
                </div>
                <div class="form-group">
                  ...
                  <select name="jl" class="form-control" required>
                    ...
                    <option value="Laki-laki" <?= $data->anggota_jenis_kelamin=='Laki-laki'?'selected':'';?>>Laki-laki</option>
                    <option value="Perempuan" <?= $data->anggota_jenis_kelamin=='Perempuan'?'selected':'';?>>Perempuan</option>
                  </select>
                </div>
                <div class="form-group">
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo base_url().'anggota/profil/update_password'?>" method="post">
