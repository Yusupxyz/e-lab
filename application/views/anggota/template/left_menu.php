    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?= (isset($pratitle))?($pratitle=='Riwayat'?'active':''):''?>">
          ...
          <ul class="treeview-menu ">
            <li class="<?= $title=='Riwayat Uji Sampel'?'active':''?>"><a href="<?php echo base_url().'anggota/riwayat_uji_sampel'?>"><i class="fa fa-clock-o"></i> Riwayat Uji Sampel</a></li>
            <li class="<?= $title=='Riwayat Transaksi'?'active':''?>"><a href="<?php echo base_url().'anggota/riwayat_transaksi'?>"><i class="fa fa-clock-o"></i> Riwayat Transaksi</a></li>
          </ul>
        </li>
