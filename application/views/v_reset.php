...
<div class="register-box">
  ...
  <p align="center"><b>E-LAB </b></p>
    ...
    <p align="center"><b>Link reset password akan dikirim ke email Anda yang telah terdaftar sebagai anggota. </b></p>

    <form action="<?php echo base_url().'administrator/reset'?>" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="email" class="form-control" placeholder="Masukkan email" required id="email">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button name="submit" type="submit" class="btn btn-primary btn-block btn-flat" id="submit">Kirim</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
