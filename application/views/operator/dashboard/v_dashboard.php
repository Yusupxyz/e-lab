     ...
     <!-- /.col -->
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Jumlah Uji Sampel</span>
            <span class="info-box-number"><?php echo  $uji_sampel;?></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Uji Sampel Selesai</span>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Uji sampel bulan <?= date("F", strtotime('m')); ?></h3>
